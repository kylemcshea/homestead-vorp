Config = {
    ...
    BoosterLogs         = {
        NoClip = GetConvar('webhook:NoClip', ''),
        InfiniteAmmo = GetConvar('webhook:InfiniteAmmo', ''),
        GoldenCores = GetConvar('webhook:GoldenCores', ''),
        GodMode = GetConvar('webhook:GodMode', ''),
        SelfHeal = GetConvar('webhook:SelfHeal', ''),
        SelfRevive = GetConvar('webhook:SelfRevive', ''),
        SelfSpawnHorse = GetConvar('webhook:SelfSpawnHorse', ''),
        SelfSpawnWagon = GetConvar('webhook:SelfSpawnWagon', ''),
    },
    AdminLogs           = {
        --simple actions
        Freezed = GetConvar('webhook:Freezed', ''),
        Bring = GetConvar('webhook:Bring', ''),
        Goto = GetConvar('webhook:Goto', ''),
        Revive = GetConvar('webhook:Revive', ''),
        Heal = GetConvar('webhook:Heal', ''),
        Warned = GetConvar('webhook:Warned', ''),
        Unwarned = GetConvar('webhook:Unwarned', ''),
        Spectate = GetConvar('webhook:Spectate', ''),
        --advanced actions
        Respawn = GetConvar('webhook:Respawn', ''),
        Kick = GetConvar('webhook:Kick', ''),
        Ban = GetConvar('webhook:Ban', ''),
        Unban = GetConvar('webhook:Unban', ''),
        Whitelist = GetConvar('webhook:Whitelist', ''),
        Unwhitelist = GetConvar('webhook:Unwhitelist', ''),
        Setgroup = GetConvar('webhook:Setgroup', ''),
        Setjob = GetConvar('webhook:Setjob', ''),
        Announce = GetConvar('webhook:Announce', '')

    },
    TeleportLogs        = {
        Tpm = GetConvar('webhook:Tpm', ''),
        Tptocoords = GetConvar('webhook:Tptocoords', ''),
        Tptoplayer = GetConvar('webhook:Tptoplayer', ''),
        Bringplayer = GetConvar('webhook:Bringplayer', ''),
    },
    DatabaseLogs        = {
        Giveitem = GetConvar('webhook:Giveitem', ''),
        Giveweapon = GetConvar('webhook:Giveweapon', ''),
        Givecurrency = GetConvar('webhook:Givecurrency', ''),
        Givehorse = GetConvar('webhook:Givehorse', ''),
        Givewagon = GetConvar('webhook:Givewagon', ''),
        Clearmoney = GetConvar('webhook:Clearmoney', ''),
        Cleargold = GetConvar('webhook:Cleargold', ''),
        Clearitems = GetConvar('webhook:Clearitems', ''),
        Clearweapons = GetConvar('webhook:Clearweapons', ''),
    }
}
